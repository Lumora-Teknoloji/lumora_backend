...
from app.core.security import create_access_token, verify_password, set_auth_cookie, clear_auth_cookie, hash_password
...
# Rate limiter for access endpoints (stricter than global)
